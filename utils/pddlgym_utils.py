...
PREDICATE_STRINGS = [
    ...
    "isusableforcpr(?:item)",
    "iscpr_stool(?:item)",
    "iscpr_stoolused(?item)",
    "iscpr_stoolusuable(?item)",
    "isaed(?:item)",
    "isusedforaed(?:item)",
    "isusableforaed(?:item)",
    "isventilator(?:item)",
    "isusableforventilation(?:item)",
    "isusedforventilation(?:item)",
    "ismedicine(?:item)",
    "iscpr_board(?:item)",
    "iscpr_boardused(?:item)",
    "iscpr_boardusuable(?:item)",
    "ischestcompressable(?:item)",
    "ischestcompressed(?:item)",
    "isrbifchestcompressed(?:item)",
    "iseligibletoreceiverescuebreaths(?:item)",
    "isrescuebreathed(?:item)",
    "istreated(?:item)",
    "issyringe(?:item)",
    "issyringeusable(?:item)",
    "issyringeused(?:item)",
    "ispump(?:item)",
    "ispumpusable(?:item)",
    "ispumpused(?:item)",
    ...
    "has(?:player,?:item)",
    "selected(?:player)",
    "cprboard-properly-placed(?:item,?:station)",
    "cancook(?:player)",
    "cancut(?:player)",
    "canmoveitem(?:player)",
    "canmove(?:player)",
    "canfry(?:player)",
    "canfrycut(?:player)",
    "cangivemedicine(?:player)",
    "cancompresschest(?:player)",
    "cangiverescuebreaths(?:player)",
    "cangiveshock(?:player)",
]
